<!-- Logbook Page -->
<main class="flex-1 p-6 mt-20 overflow-y-auto bg-gray-100">
    <h2 class="text-2xl font-semibold text-gray-700 mb-4">Verifier Logbook</h2>
    <p class="text-gray-700 text-normal mb-8">View and manage logs of student check-in and check-out activities.</p>
