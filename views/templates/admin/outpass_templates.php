<main class="flex-1 p-6 mt-20 overflow-y-auto">
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <button class="inline-flex items-center px-5 py-2 text-sm font-medium text-white transition-all duration-200 ease-in-out bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 focus:ring focus:ring-blue-400">
        ...
        <table class="w-full text-sm table-auto">
            ...
            <tbody class="divide-y divide-gray-200">
                <tr class="transition hover:bg-gray-50">
                    <td class="px-5 py-4">
                        <div class="inline-flex items-center justify-between mb-1">
                            <div class="font-medium text-gray-800">Home Leave</div>
                            <span class="ms-4 px-2 py-0.5 text-xs bg-gray-200 text-gray-700 rounded-full">
                                System Template
                            </span>
                        </div>
                        <p class="text-sm text-gray-500">Used when students visit home during weekends or holidays.</p>
                    </td>
                    <td class="px-5 py-4">
                        <span class="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-green-800 bg-green-100 rounded-md">
                            B.Tech • Gents Hostel 4
                        </span>
                    </td>
                    <td class="px-5 py-4">
                        <div class="flex flex-wrap gap-2">
                            <span class="px-2 py-0.5 text-xs bg-gray-100 text-gray-800 rounded">Guardian Contact</span>
                            <span class="px-2 py-0.5 text-xs bg-gray-100 text-gray-800 rounded">Location</span>
                            <span class="px-2 py-0.5 text-xs bg-gray-100 text-gray-800 rounded">Attachment</span>
                        </div>
                    </td>
                    <td class="px-5 py-4">
                ...
                <tr class="transition hover:bg-gray-50">
                    <td class="px-5 py-4">
                        <div class="inline-flex items-center justify-between mb-1">
                            <div class="font-medium text-gray-800">Medical Visit</div>
                            <span class="ms-4 px-2 py-0.5 text-xs bg-gray-200 text-gray-700 rounded-full">
                                System Template
                            </span>
                        </div>
                        <p class="text-sm text-gray-500">Used when students visit hospital/clinic during academic hours.</p>
                    </td>
                    <td class="px-5 py-4">
                    ...
                    <td class="px-5 py-4">
                        <div class="flex flex-wrap gap-2">
                            <span class="px-2 py-0.5 text-xs bg-gray-100 text-gray-800 rounded">Hospital Details</span>
                            <span class="px-2 py-0.5 text-xs bg-gray-100 text-gray-800 rounded">Time Range</span>
                        </div>
                    </td>
                    <td class="px-5 py-4">
