<div class="px-2 space-y-6">
    <h3 class="text-xl font-bold text-gray-900">Edit Program</h3>
            ...
            <div class="space-y-2">
                ...
                <select id="program-institution" name="program-institution" required
                    ...
                    <?php foreach (($institutions ?? []) as $institution): ?>
                        <option value="<?= $institution['id'] ?>" <?= ($program['institution_id'] ?? '') == $institution['id'] ? 'selected' : '' ?>><?= $institution['name'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
