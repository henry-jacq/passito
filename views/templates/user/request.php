        ...
        <form id="outpassForm">
            ...
            <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="passType" required onchange="toggleDestinationInput()">
                ...
                <div class="mb-3" id="destinationField" style="display: none;">
                    ...
                    <input type="text" class="form-control" id="destination" placeholder="Enter the place you are visiting">
                </div>
                <div class="mb-3">
                    <label for="purpose" class="form-label">Purpose/Reason</label>
                    <textarea class="form-control" id="purpose" rows="3" placeholder="Enter the purpose or reason" required></textarea>
                    <small class="form-label">Outpass will be issued if the reason is valid.</small>
                </div>
            </div>
